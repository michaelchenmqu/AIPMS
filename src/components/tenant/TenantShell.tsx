...
const NAV = [
  ...
  { href: "/tenant/statement", label: "Statement" },
  { href: "/tenant/maintenance", label: "Maintenance" },
];

export default function TenantShell({ children, tenantName }: { children: ReactNode; tenantName: string }) {
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 flex items-center justify-between h-16">
          <div className="flex items-center gap-8">
            <span className="font-[family-name:var(--font-serif)] font-bold whitespace-nowrap">
              AIPMS <span className="hidden sm:inline">· Tenant portal</span>
            </span>
          ...
          <button onClick={() => setMenuOpen((v) => !v)} aria-label="Open menu" className="md:hidden p-1.5 text-white">
